...
2팀   ██ DB/API ███ SITE-INFO ███ RESOURCE ████████ SAFETY ████████ WIS/도면열람 ███ 안정화
```
...
> 1팀: Open-Meteo + 검색/알림 | 2팀: WIS/도면 열람 시스템 + Support
...
#### 2팀 — WIS/도면 열람 시스템 + Support

> 현재상태: ✅ Phase 5 2팀 핵심 완료 (WIS 동기화/재시도 + 도면 열람 시스템 연계 화면 + Support FAQ/티켓 + 모바일 반응형 보정)

| 작업 | 상세 | 산출물 |
|------|------|--------|
| ✅ WIS 연동 | 출역현황, 안전교육현황 데이터 | WIS 데이터 표시, 동기화 배치 |
| ✅ 도면 열람 시스템 연동 | 설계도면 검색/열람 바로가기 | 도면 열람 시스템 연계 화면 |
...
| 외부 링크 | WIS / 도면 열람 시스템 / Support | 새 탭 열기 |
...
| 도면 열람 시스템 | 2팀 | 설계도면/자료 관리 | 도면 검색/열람 바로가기 |
