...
export default function DesignDocsPage() {
  const sections = [
    ...
    { href: "/design-docs/documents/ledgers/instruction", label: "업무지시" },
    { href: "/design-docs/documents/ledgers/correspondence", label: "문서 수신/발신" },
    ...
    <section className="space-y-4 rounded-xl border border-border bg-background-card p-6 shadow-[var(--shadow-soft)]">
      <header>
        ...
        <p className="mt-2 text-sm text-foreground-muted">
          Phase 3 1팀 모듈 시작 상태입니다. 도면검토/문서 작성 플로우/대장/분류체계를 순차 구현합니다.
        </p>
      </header>
